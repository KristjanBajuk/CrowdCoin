...
const Show = (props) => {
  ...
  const items = [
    ...
    },
    {
      ...
      description:
        "You must contribute at this musch wei to become a approver",
    },
    {
        ...
        <Grid container spacing={2}>
          {items?.map((item, index) => (
            ...
            <Grid item xs={6} key={index}>
              <Card variant="outlined" sx={{p:1}} sx={{minHeight: '200px'}}>
                <CardContent>
                  <Typography sx={{overflowWrap: 'break-word'}} variant="h6" component="div">
                    {item?.header}
                  </Typography>
